<html>
<body>
<b>sudo apt-get install php5-gd</b><p>
...
WS %: <input type="text" name="wsChangePc" value=5 /><br/>
LWY Decile: <input type="text" name="lwDecile" value=10 /><br/>
LWY MM: <input type="text" name="lwAmtMm" value=555 /><br/>
SM %: <input type="text" name="smChangePc" value=10 /><br/>
